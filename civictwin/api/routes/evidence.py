...
from civictwin.analysis.redundancy import redundancy_groups, system_score
...
def assumptions(
    ...
    """Why civic-twin thinks what it thinks about an asset or a result."""
...
def objectives(state: State) -> dict[str, object]:
    ...
    from civictwin.analysis.objectives import OBJECTIVES
