...
class ToolBox:
    ...
    def get_asset(self, asset_id: str) -> dict[str, Any]:
        from civictwin.api.routes.township import get_asset as endpoint
    ...
    def trace_dependencies(
        ...
        from civictwin.api.routes.township import trace as endpoint
    ...
    def run_scenario(
        ...
        from civictwin.api.routes.scenarios import run_scenario as endpoint
        from civictwin.api.schemas import ScenarioRequest
    ...
    def compare_scenarios(self, a: str, b: str) -> dict[str, Any]:
        from civictwin.api.routes.scenarios import compare as endpoint
    ...
    def get_criticality(
        ...
        from civictwin.api.routes.analytics import criticality as endpoint
    ...
    def get_spofs(self, limit: int = 5) -> dict[str, Any]:
        from civictwin.api.routes.analytics import spofs as endpoint
    ...
    def get_plan(self, budget_inr: float) -> dict[str, Any]:
        from civictwin.api.routes.plans import get_plan as endpoint
