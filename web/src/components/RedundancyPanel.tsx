...
export function RedundancyPanel({
  ...
  if (groups.length === 0) {
    return <div className="dim" style={{ fontSize: 13, padding: 10 }}>No redundancy groups.</div>;
  }
  return (
    <div className="panel" style={{ padding: 10 }}>
      ...
      <div className="dim" style={{ fontSize: 12, margin: "4px 0 8px", lineHeight: 1.5 }}>
      ...
      <div className="col" style={{ gap: 8 }}>
        {groups.map((g) => (
          <div key={g.id} style={{ borderTop: "1px solid var(--border)", paddingTop: 6 }}>
            ...
            <div className="row mono dim" style={{ fontSize: 12, gap: 10 }}>
              <span>nominal {g.nominal_paths}</span>
              <span style={{ color: g.weak ? "var(--f-critical-text)" : undefined }}>
