...
from gotham.analysis.ledger import for_result
from gotham.api.state import AppState, get_state
from gotham.hazard.ingestion.api import UnsupportedForecast, ingest
from gotham.hazard.normalization.normalizer import SCENARIO_FAMILIES
from gotham.hazard.schemas.forecast import HazardType, UncertaintySource
...
def hazard_schema(state: State) -> dict[str, object]:
    """What a provider has to send, and what gotham does with it."""
    return {
        ...
        "note": (
            "gotham does not forecast weather. It takes a hazard from an "
