...
from gotham.engine.contract import (
    HazardScenario,
    Overlay,
    SharedState,
    SimResult,
...
from gotham.engine.demand import DemandModel
from gotham.engine.hazard import HazardModel
from gotham.engine.layers.comms import CommsLayer
...
from gotham.engine.loss import accumulate, make_accumulator
from gotham.engine.response import POLICY_GREEDY, ResponseModel
from gotham.engine.states import classify
...
class Engine:
    ...
    def _bundle(self, extra_links: tuple[str, ...]) -> _Bundle:
        ...
        if cached is not None:
            return cached
        from gotham.analysis.interventions import apply_structural
    ...
    def simulate(
        ...
        """
        from gotham.analysis.interventions import resolve
    ...
    def new_state(self, town: Township | None = None) -> SharedState:
        ...
        from gotham.analysis.interventions import Effect
...
def _objective_scorer(
    ...
    from gotham.analysis.objectives import UNRECOVERED_H, _weight
